...
const orderSchema = new mongoose.Schema({
  ...
  items:         [{ name: String, quantity: Number, price: Number, notes: { type: String, default: '' }, isAlcoholic: { type: Boolean, default: false }, department: { type: String, default: 'kitchen' } }],
  subtotal:      { type: Number, required: true },
  foodSubtotal:  { type: Number, default: 0 },
  alcoholSubtotal:{ type: Number, default: 0 },
